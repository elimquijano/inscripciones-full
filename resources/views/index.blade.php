...
@section('main')
    <ul class="nav nav-tabs" role="tablist">
        <li class="nav-item">
            <a class="nav-link btn-danger" href="{{ route('grupal') }}">Inscribir Muchos Alumnos con Tutor por I.E.</a>
        </li>
        <li class="nav-item">
            <a class="nav-link active" href="{{ route('index') }}">Inscribir Un Solo Alumno Sin Tutor</a>
        </li>
    </ul>
